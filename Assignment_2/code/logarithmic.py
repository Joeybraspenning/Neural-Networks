...
for HIDDEN_SIZE in [64]:
    for BATCH_SIZE in [256]:
        for LAYERS in [2]:
            ...
            np.save('logarithmic_accuracies_{}_{}_{}_new'.format(HIDDEN_SIZE, BATCH_SIZE, LAYERS), np.array(training_accuracies))
            np.save('logarithmic_losses_{}_{}_{}_new'.format(HIDDEN_SIZE, BATCH_SIZE, LAYERS), np.array(training_losses))
            np.save('logarithmic_precisions_{}_{}_{}_new'.format(HIDDEN_SIZE, BATCH_SIZE, LAYERS), np.array(training_precisions))
