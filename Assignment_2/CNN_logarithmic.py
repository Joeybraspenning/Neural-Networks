...
np.save('logarithmic_accuracies_CNN_tanh', np.array(training_accuracies))
np.save('logarithmic_losses_CNN_tanh', np.array(training_losses))
np.save('logarithmic_precisions_CNN_tanh', np.array(training_precisions))
