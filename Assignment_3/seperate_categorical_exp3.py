...
# categories = load_obj('./bachelor_data/input_matrix_exp3.pickle')[:, :, 0]
...
# np.save('categories_exp3', categories)

spectra = np.load('spectra_exp3.npy')
categories = np.load('categories_exp3.npy')
...
for num in range(1):
   ...
   for i in range(7):
     ...
     save_obj(hist.history, 'history_exp3_{}'.format(i))
